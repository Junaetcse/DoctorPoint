...
public class DiabetisDoctorAdapter extends RecyclerView.Adapter<DiabetisDoctorAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DiabetisDoctorAdapter.MyViewHolder(iView);
    }
    ...
    public DiabetisDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
