...
public class CardioDoctorAdapter  extends RecyclerView.Adapter<CardioDoctorAdapter.MyViewHolder>{
    private List<Doctorsinfo> doctorsinfoList;
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View iView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_row, parent, false);
        return new CardioDoctorAdapter.MyViewHolder(iView);
    }
    @Override
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {/**/
                    ...
                    Intent intent = new Intent(context, CardiologyAppointment.class);
    ...
    public CardioDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
