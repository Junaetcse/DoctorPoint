...
public class AppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.appintactivity_style);
        initialize();
        ...
        pd = new ProgressDialog(AppointmentActivity.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(AppointmentActivity.this);
                android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(AppointmentActivity.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(AppointmentActivity.this, ListActivity.class);
    ...
    public void appointment(View view){
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<AppointDoctor> call=apiInterface.insertPatientInfo(appointDoctor.getDoctorId(),appointDoctor.getPatientSerial(),
                ...
                call.enqueue(new Callback<AppointDoctor>() {
                    ...
                    public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                        Toast.makeText(AppointmentActivity.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
