...
public class SurgeryDoctorAdaptor extends RecyclerView.Adapter<SurgeryDoctorAdaptor.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SurgeryDoctorAdaptor.MyViewHolder(iView);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, SurgaryAppointment.class);
    ...
    public SurgeryDoctorAdaptor(List<Doctorsinfo> doctorsinfoList) {
