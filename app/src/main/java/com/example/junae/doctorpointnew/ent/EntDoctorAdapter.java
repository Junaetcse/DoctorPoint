...
public class EntDoctorAdapter extends RecyclerView.Adapter<EntDoctorAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new EntDoctorAdapter.MyViewHolder(iView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, EntAppointment.class);
    ...
    public EntDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
