...
public class CardiologyAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cardiology_appointment);
        initialize();
        ...
        pd = new ProgressDialog(CardiologyAppointment.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(CardiologyAppointment.this);
                android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(CardiologyAppointment.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(CardiologyAppointment.this, CardiologyListActivity.class);
    ...
    public void cardio_appointment(View view){
     ...
     final EditText userSerial = (EditText) alertLayout.findViewById(R.id.patent_serial);
        ...
        alert.setTitle("Your Appoint Info");
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<AppointDoctor> call=apiInterface.insertCarddioPatient(appointDoctor.getDoctorId(),
                        appointDoctor.getPatientSerial(),appointDoctor.getPatientDate(),appointDoctor.getPatientName(),appointDoctor.getPatientAddress(),appointDoctor.getPatientNumber());
                call.enqueue(new Callback<AppointDoctor>() {
                    @Override
                    public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                        Toast.makeText(CardiologyAppointment.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
                    }
                    @Override
                    public void onFailure(Call<AppointDoctor> call, Throwable t) {
                        Toast.makeText(CardiologyAppointment.this, "response"+t, Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
    ...
    public void initialize(){
        ...
        search = (Button)findViewById(R.id.cardio_search);
    }
