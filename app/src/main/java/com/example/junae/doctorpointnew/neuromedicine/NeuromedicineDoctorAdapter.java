...
/**
 * Created by junae on 11/18/2017.
 */

public class NeuromedicineDoctorAdapter extends RecyclerView.Adapter<NeuromedicineDoctorAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new NeuromedicineDoctorAdapter.MyViewHolder(iView);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, NeuromedicineAppointment.class);
    ...
    public NeuromedicineDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
