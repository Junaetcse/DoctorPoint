...
public class OrthopedicAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orthopedic_appointment);
        ...
        pd = new ProgressDialog(OrthopedicAppointment.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(OrthopedicAppointment.this);
                android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(OrthopedicAppointment.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(OrthopedicAppointment.this, OrthopedicListActivity.class);
    ...
    public void orthopedic_appointment(View view){
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<AppointDoctor> call=apiInterface.insertOrthopedicPatient(appointDoctor.getDoctorId(),appointDoctor.getPatientSerial(),
                ...
                call.enqueue(new Callback<AppointDoctor>() {
                    ...
                    public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                        Toast.makeText(OrthopedicAppointment.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(Call<AppointDoctor> call, Throwable t) {
                        Toast.makeText(OrthopedicAppointment.this, "response"+t, Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void initialize(){
        ...
        search = (Button)findViewById(R.id.orthopedic_search);
