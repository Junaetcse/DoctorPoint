...
public class NeuromedicineAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neuromedicine_appointment);
        ...
        pd = new ProgressDialog(NeuromedicineAppointment.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(NeuromedicineAppointment.this);
                android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(NeuromedicineAppointment.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(NeuromedicineAppointment.this, NeuromedicineListActivity.class);
    ...
    public void neuromedicine_appointment(View view){
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<AppointDoctor> call=apiInterface.insertNeuromedicinePatient(appointDoctor.getDoctorId(),appointDoctor.getPatientSerial(),
                ...
                call.enqueue(new Callback<AppointDoctor>() {
                    ...
                    public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                        Toast.makeText(NeuromedicineAppointment.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(Call<AppointDoctor> call, Throwable t) {
                        Toast.makeText(NeuromedicineAppointment.this, "response"+t, Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void initialize(){
        ...
        search = (Button)findViewById(R.id.neuromedicine_search);
