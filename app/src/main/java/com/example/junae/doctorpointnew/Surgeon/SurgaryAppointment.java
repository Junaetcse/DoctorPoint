...
public class SurgaryAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surgary_appointment);
        initialize();
        ...
        pd = new ProgressDialog(SurgaryAppointment.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(SurgaryAppointment.this);
                android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(SurgaryAppointment.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(SurgaryAppointment.this, SurgeryListActivity.class);
    ...
    public void surgery_appointment(View view){
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<AppointDoctor> call=apiInterface.insertSurgeryPatient(appointDoctor.getDoctorId(),appointDoctor.getPatientSerial(),
                ...
                call.enqueue(new Callback<AppointDoctor>() {
                    ...
                    public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                        Toast.makeText(SurgaryAppointment.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(Call<AppointDoctor> call, Throwable t) {
                        Toast.makeText(SurgaryAppointment.this, "response"+t, Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void initialize(){
        ...
        search = (Button)findViewById(R.id.surgery_search);
