...
import com.example.junae.doctorpointnew.favorite_doctor.DatabaseHandler;
import com.example.junae.doctorpointnew.favorite_doctor.FavoriteActivity;
import com.example.junae.doctorpointnew.favorite_doctor.SqliteModel;
...
public class DiabetisAppointmentActivity extends AppCompatActivity {
    ...
    String id,name,Qualification,Designation,expertise,organization,chamber,visiting_Hours,location,phone,email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diabetis_appointment);
       ...
       chamber = intent.getStringExtra("chamber");
        visiting_Hours = intent.getStringExtra("visiting_Hours");
        ...
        pd = new ProgressDialog(DiabetisAppointmentActivity.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(DiabetisAppointmentActivity.this);
                AlertDialog.Builder alert = new AlertDialog.Builder(DiabetisAppointmentActivity.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        userDate.setHint("__/__/__");
                        Intent intent = new Intent(DiabetisAppointmentActivity.this, DiabetisListActivity.class);
...
public void dia_appointment(View view){
    ...
    alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            Call<AppointDoctor> call=apiInterface.insertDaibetisPatient(appointDoctor.getDoctorId(),appointDoctor.getPatientSerial(),
            ...
            call.enqueue(new Callback<AppointDoctor>() {
                ...
                public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                    Toast.makeText(DiabetisAppointmentActivity.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
                ...
                public void onFailure(Call<AppointDoctor> call, Throwable t) {
                    Toast.makeText(DiabetisAppointmentActivity.this, "response"+t, Toast.LENGTH_LONG).show();
                }
            });
    ...
    public void initialize(){
        ...
        search = (Button)findViewById(R.id.diabetis_search);
