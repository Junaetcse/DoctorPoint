...
public class UrologyDoctorAdapter extends RecyclerView.Adapter<UrologyDoctorAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new UrologyDoctorAdapter.MyViewHolder(iView);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, UrologyAppointment.class);
    ...
    public UrologyDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
