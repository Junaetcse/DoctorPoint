...
/**
 * Created by junae on 11/19/2017.
 */

public class GastologyAdapter extends RecyclerView.Adapter<GastologyAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new GastologyAdapter.MyViewHolder(iView);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, GastologyAppointment.class);
    ...
    public GastologyAdapter(List<Doctorsinfo> doctorsinfoList) {
