...
public class GynecologyDoctorAdapter extends RecyclerView.Adapter<GynecologyDoctorAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new GynecologyDoctorAdapter.MyViewHolder(iView);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, GynecologyAppointment.class);
    ...
    public GynecologyDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
