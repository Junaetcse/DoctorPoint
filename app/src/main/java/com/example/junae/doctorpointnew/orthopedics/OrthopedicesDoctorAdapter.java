...
public class OrthopedicesDoctorAdapter extends RecyclerView.Adapter<OrthopedicesDoctorAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new OrthopedicesDoctorAdapter.MyViewHolder(iView);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /**/
                    ...
                    Intent intent = new Intent(context, OrthopedicAppointment.class);
    ...
    public OrthopedicesDoctorAdapter(List<Doctorsinfo> doctorsinfoList) {
