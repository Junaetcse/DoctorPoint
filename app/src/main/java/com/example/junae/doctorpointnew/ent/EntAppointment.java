...
public class EntAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ent_appointment);
        ...
        pd = new ProgressDialog(EntAppointment.this);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText userDate = new EditText(EntAppointment.this);
                android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(EntAppointment.this);
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(EntAppointment.this, EntListActivity.class);
    ...
    public void ent_appointment(View view){
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Call<AppointDoctor> call=apiInterface.insertEntPatient(appointDoctor.getDoctorId(),appointDoctor.getPatientSerial(),
                ...
                call.enqueue(new Callback<AppointDoctor>() {
                    ...
                    public void onResponse(Call<AppointDoctor> call, Response<AppointDoctor> response) {
                        Toast.makeText(EntAppointment.this, "Successfully Appointed . Date is:   "+userDate, Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(Call<AppointDoctor> call, Throwable t) {
                        Toast.makeText(EntAppointment.this, "response"+t, Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void initialize(){
        ...
        search = (Button)findViewById(R.id.ent_search);
